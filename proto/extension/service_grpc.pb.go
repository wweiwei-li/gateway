...
type EnvoyGatewayExtensionClient interface {
	...
	// PostEndpointsModify provides a way for extensions to modify a ClusterLoadAssignment generated by Envoy Gateway
	// before it is sent over EDS. This allows extensions to set per-endpoint metadata or apply endpoint overrides.
	PostEndpointsModify(ctx context.Context, in *PostEndpointsModifyRequest, opts ...grpc.CallOption) (*PostEndpointsModifyResponse, error)
	// PostTranslateModify allows an extension to modify the translated xDS resources before they are sent to Envoy.
	// Extensions can inspect and update the generated clusters, secrets, listeners, and routes, or inject additional resources
...
func (c *envoyGatewayExtensionClient) PostRouteModify(ctx context.Context, in *PostRouteModifyRequest, opts ...grpc.CallOption) (*PostRouteModifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, EnvoyGatewayExtension_PostRouteModify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *envoyGatewayExtensionClient) PostVirtualHostModify(ctx context.Context, in *PostVirtualHostModifyRequest, opts ...grpc.CallOption) (*PostVirtualHostModifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, EnvoyGatewayExtension_PostVirtualHostModify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *envoyGatewayExtensionClient) PostHTTPListenerModify(ctx context.Context, in *PostHTTPListenerModifyRequest, opts ...grpc.CallOption) (*PostHTTPListenerModifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, EnvoyGatewayExtension_PostHTTPListenerModify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *envoyGatewayExtensionClient) PostEndpointsModify(ctx context.Context, in *PostEndpointsModifyRequest, opts ...grpc.CallOption) (*PostEndpointsModifyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PostEndpointsModifyResponse)
	err := c.cc.Invoke(ctx, EnvoyGatewayExtension_PostEndpointsModify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *envoyGatewayExtensionClient) PostTranslateModify(ctx context.Context, in *PostTranslateModifyRequest, opts ...grpc.CallOption) (*PostTranslateModifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, EnvoyGatewayExtension_PostTranslateModify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EnvoyGatewayExtensionServer interface {
	...
	// PostEndpointsModify provides a way for extensions to modify a ClusterLoadAssignment generated by Envoy Gateway
	// before it is sent over EDS. This allows extensions to set per-endpoint metadata or apply endpoint overrides.
	PostEndpointsModify(context.Context, *PostEndpointsModifyRequest) (*PostEndpointsModifyResponse, error)
	// PostTranslateModify allows an extension to modify the translated xDS resources before they are sent to Envoy.
	// Extensions can inspect and update the generated clusters, secrets, listeners, and routes, or inject additional resources
	// that need to be created dynamically.
	// The lists returned by the extension are used as the final lists of clusters, secrets, listeners, and routes.
...
// UnimplementedEnvoyGatewayExtensionServer must be embedded to have
...
func (UnimplementedEnvoyGatewayExtensionServer) PostEndpointsModify(context.Context, *PostEndpointsModifyRequest) (*PostEndpointsModifyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PostEndpointsModify not implemented")
}
...
func RegisterEnvoyGatewayExtensionServer(s grpc.ServiceRegistrar, srv EnvoyGatewayExtensionServer) {
	// If the following call pancis, it indicates UnimplementedEnvoyGatewayExtensionServer was
...
func _EnvoyGatewayExtension_PostEndpointsModify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PostEndpointsModifyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EnvoyGatewayExtensionServer).PostEndpointsModify(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EnvoyGatewayExtension_PostEndpointsModify_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvoyGatewayExtensionServer).PostEndpointsModify(ctx, req.(*PostEndpointsModifyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EnvoyGatewayExtension_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PostEndpointsModify",
			Handler:    _EnvoyGatewayExtension_PostEndpointsModify_Handler,
		},
		{
